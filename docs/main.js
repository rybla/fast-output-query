...
(() => {
  ...
  var slot1 = /* @__PURE__ */ slot2(EngineIsSymbol)(ordUnit);
  var ViewIsSymbol = {
    reflectSymbol: function() {
      return "View";
    }
  };
  var slot22 = /* @__PURE__ */ slot2(ViewIsSymbol)(ordUnit);
  var tell3 = /* @__PURE__ */ tell2();
  var tell1 = /* @__PURE__ */ tell3(EngineIsSymbol)(ordUnit);
  var tell22 = /* @__PURE__ */ tell3(ViewIsSymbol)(ordUnit);
  var ViewOutput = /* @__PURE__ */ function() {
    function ViewOutput2(value0) {
      this.value0 = value0;
    }
    ;
    ViewOutput2.create = function(value0) {
      return new ViewOutput2(value0);
    };
    return ViewOutput2;
  }();
  var ViewAction = /* @__PURE__ */ function() {
    function ViewAction2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ViewAction2.create = function(value0) {
      return function(value1) {
        return new ViewAction2(value0, value1);
      };
    };
    return ViewAction2;
  }();
  var EngineQuery = /* @__PURE__ */ function() {
    function EngineQuery2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    EngineQuery2.create = function(value0) {
      return function(value1) {
        return new EngineQuery2(value0, value1);
      };
    };
    return EngineQuery2;
  }();
  var EngineOutput = /* @__PURE__ */ function() {
    function EngineOutput2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    EngineOutput2.create = function(value0) {
      return function(value1) {
        return new EngineOutput2(value0, value1);
      };
    };
    return EngineOutput2;
  }();
  var ViewQuery = /* @__PURE__ */ function() {
    function ViewQuery2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ViewQuery2.create = function(value0) {
      return function(value1) {
        return new ViewQuery2(value0, value1);
      };
    };
    return ViewQuery2;
  }();
  var EngineOutput_AppAction = /* @__PURE__ */ function() {
    function EngineOutput_AppAction2(value0) {
      this.value0 = value0;
    }
    ;
    EngineOutput_AppAction2.create = function(value0) {
      return new EngineOutput_AppAction2(value0);
    };
    return EngineOutput_AppAction2;
  }();
  var ViewOutput_AppAction = /* @__PURE__ */ function() {
    function ViewOutput_AppAction2(value0) {
      this.value0 = value0;
    }
    ;
    ViewOutput_AppAction2.create = function(value0) {
      return new ViewOutput_AppAction2(value0);
    };
    return ViewOutput_AppAction2;
  }();
  var component_View = function(dictMonadAff) {
    ...
    var render = function(state3) {
      return div2([style("display: flex; flex-direction: column; gap: 0.5em;")])(mapWithIndex2(function(i2) {
        return function(value12) {
          return div2([onClick(function(e) {
            return new ViewAction(e, i2);
          }), style(function() {
            if (value12) {
              return "color: blue";
            }
    ...
    var initialState = function(v) {
      return {
        values: append5([true])(replicate(10)(false))
      };
    };
    var $$eval = mkEval({
  ...
  var component_Engine = /* @__PURE__ */ function() {
  ...
  var component_App = function(dictMonadAff) {
    var component_View1 = component_View(dictMonadAff);
    var render = function(v) {
      return div2([])([slot1($$Proxy.value)(unit)(component_Engine)({})(EngineOutput_AppAction.create), slot22($$Proxy.value)(unit)(component_View1)({})(ViewOutput_AppAction.create)]);
    };
    var initialState = function(v) {
      return {};
    };
    var handleAction = function(v) {
      if (v instanceof ViewOutput_AppAction) {
        return tell1($$Proxy.value)(unit)(EngineQuery.create(v.value0));
      }
      ;
      if (v instanceof EngineOutput_AppAction) {
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ bindFlipped(bindAff)(/* @__PURE__ */ runUI2(/* @__PURE__ */ component_App(monadAffAff))({}))(awaitBody));
